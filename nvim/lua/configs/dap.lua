...
dap.adapters = {
  ["pwa-node"] = {
    type = "server",
    host = "::1", -- Usa la dirección IPv6 (::1) o "127.0.0.1" para IPv4
    port = 8123,  -- Usa el puerto en el que se está ejecutando el servidor
    executable = {
      command = "node",
      args = {
        vim.fn.stdpath("data") .. "/mason/packages/js-debug-adapter/js-debug/src/dapDebugServer.js", -- Ruta al archivo del servidor
        "--port=8123", -- Especifica el puerto manualmente
      },
    },
  },
